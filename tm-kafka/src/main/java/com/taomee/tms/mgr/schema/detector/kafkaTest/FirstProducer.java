...
public class FirstProducer {
	 public static void main(String[] args) {
         ...
         props.put("bootstrap.servers","10.1.1.228:9092,10.1.1.225:9092,10.1.1.223:9092");//该地址是集群的子集，用来探测集群。
         ...
         for (int i = 0; i < 10000; i++) {
             ...
             producer.send(new ProducerRecord<String, String>("kafka-pcc-input",Integer.toString(i), Integer.toString(i)));
         }
         producer.close();
     }
